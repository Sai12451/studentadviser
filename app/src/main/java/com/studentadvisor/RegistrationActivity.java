...
public class RegistrationActivity extends AppCompatActivity {
    ...
    Button btn_submit;
    EditText et_name,et_email,et_phone,et_password,et_student_id;
    ...
    private void CreateAccount() {
        ...
        String sid = et_student_id.getText().toString();
        ...
        {
            Toast.makeText(this, "Please write your Sid number...", Toast.LENGTH_SHORT).show();
        }
        ...
        else
        {
            ...
            ValidatepEmail(sid,phone,email,password);
        }
    }

    private void ValidatepEmail(final String sid,final String phone, final String email,String password) {
